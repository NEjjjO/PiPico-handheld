...
#
# Connect 128x64 OLED SDA to GPIO 0, SCL to GPIO 1
...
def setupUI():
    ...
    buttonRight = Pin(18, Pin.IN, Pin.PULL_UP)
    buttonLeft = Pin(17, Pin.IN, Pin.PULL_UP)
    buttonDown = Pin(16, Pin.IN, Pin.PULL_UP)
    buttonUp = Pin(19, Pin.IN, Pin.PULL_UP)
